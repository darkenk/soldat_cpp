...
{
public:
	constexpr GostekSprite(const std::string_view id,
...
static constexpr std::array<GostekSprite, 131> sGostekSpritesDefaults = {
	...
	GostekSprite("Secondary_Mp5", GFX::WEAPONS_MP5, 5, 10, 0.3, 0.3, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Ak74", GFX::WEAPONS_AK74, 5, 10, 0.3, 0.25, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Steyr", GFX::WEAPONS_STEYR, 5, 10, 0.3, 0.5, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Spas", GFX::WEAPONS_SPAS, 5, 10, 0.3, 0.3, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Ruger", GFX::WEAPONS_RUGER, 5, 10, 0.3, 0.3, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_M79", GFX::WEAPONS_M79, 5, 10, 0.3, 0.35, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Barrett", GFX::WEAPONS_BARRETT, 5, 10, 0.3, 0.35, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Minimi", GFX::WEAPONS_MINIMI, 5, 10, 0.3, 0.35, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Minigun", GFX::WEAPONS_MINIGUN, 5, 10, 0.2, 0.5, 0, 1, 0, 0, color_none, alpha_base),
	...
	GostekSprite("Secondary_Chainsaw", GFX::WEAPONS_CHAINSAW, 5, 10, 0.25, 0.5, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Secondary_Law", GFX::WEAPONS_LAW, 5, 10, 0.3, 0.45, 0, 1, 0, 0, color_none, alpha_base),
	...
	GostekSprite("Secondary_Flamer", GFX::WEAPONS_FLAMER, 5, 10, 0.3, 0.3, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Left_Thigh", GFX::GOSTEK_UDO, 6, 3, 0.2, 0.5, 1, 1, 1, 5, color_pants, alpha_base),

	GostekSprite("Left_Thigh_Dmg", GFX::GOSTEK_RANNY_UDO, 6, 3, 0.2, 0.5, 0, 1, 1, 5, color_none, alpha_blood),

	GostekSprite("Left_Foot", GFX::GOSTEK_STOPA, 2, 18, 0.35, 0.35, 1, 1, 1, 0, color_none, alpha_base),

	GostekSprite("Left_Jetfoot", GFX::GOSTEK_LECISTOPA, 2, 18, 0.35, 0.35, 0, 1, 1, 0, color_none, alpha_base),

	GostekSprite("Left_Lowerleg", GFX::GOSTEK_NOGA, 3, 2, 0.15, 0.55, 1, 1, 1, 0, color_pants, alpha_base),

	GostekSprite("Left_Lowerleg_Dmg", GFX::GOSTEK_RANNY_NOGA, 3, 2, 0.15, 0.55, 0, 1, 1, 0, color_none, alpha_blood),

	GostekSprite("Left_Arm", GFX::GOSTEK_RAMIE, 11, 14, 0, 0.5, 1, 1, 1, 0, color_main, alpha_base),

	GostekSprite("Left_Arm_Dmg", GFX::GOSTEK_RANNY_RAMIE, 11, 14, 0, 0.5, 0, 1, 1, 0, color_none, alpha_blood),

	GostekSprite("Left_Forearm", GFX::GOSTEK_REKA, 14, 15, 0, 0.5, 1, 0, 1, 5, color_main, alpha_base),

	GostekSprite("Left_Forearm_Dmg", GFX::GOSTEK_RANNY_REKA, 14, 15, 0, 0.5, 0, 1, 1, 5, color_none, alpha_blood),

	GostekSprite("Left_Hand", GFX::GOSTEK_DLON, 15, 19, 0, 0.4, 1, 1, 1, 0, color_skin, alpha_base),

	GostekSprite("Grabbed_Helmet", GFX::GOSTEK_HELM, 15, 19, 0, 0.5, 0, 1, 1, 0, color_main, alpha_base),

	GostekSprite("Grabbed_Hat", GFX::GOSTEK_KAP, 15, 19, 0.1, 0.4, 0, 1, 1, 0, color_main, alpha_base),

	GostekSprite("Right_Thigh", GFX::GOSTEK_UDO, 5, 4, 0.2, 0.65, 1, 1, 1, 5, color_pants, alpha_base),

	GostekSprite("Right_Thigh_Dmg", GFX::GOSTEK_RANNY_UDO, 5, 4, 0.2, 0.65, 0, 1, 1, 5, color_none, alpha_blood),

	GostekSprite("Right_Foot", GFX::GOSTEK_STOPA, 1, 17, 0.35, 0.35, 1, 1, 1, 0, color_none, alpha_base),

	GostekSprite("Right_Jetfoot", GFX::GOSTEK_LECISTOPA, 1, 17, 0.35, 0.35, 0, 1, 1, 0, color_none, alpha_base),

	GostekSprite("Right_Lowerleg", GFX::GOSTEK_NOGA, 4, 1, 0.15, 0.55, 1, 1, 1, 0, color_pants, alpha_base),

	GostekSprite("Right_Lowerleg_Dmg", GFX::GOSTEK_RANNY_NOGA, 4, 1, 0.15, 0.55, 0, 1, 1, 0, color_none, alpha_blood),
	...
	GostekSprite("Chest_Dmg", GFX::GOSTEK_RANNY_KLATA, 10, 11, 0.1, 0.3, 0, 1, 1, 0, color_none, alpha_blood),

	GostekSprite("Hip", GFX::GOSTEK_BIODRO, 5, 6, 0.25, 0.6, 1, 1, 1, 0, color_main, alpha_base),

	GostekSprite("Hip_Dmg", GFX::GOSTEK_RANNY_BIODRO, 5, 6, 0.25, 0.6, 0, 1, 1, 0, color_none, alpha_blood),

	GostekSprite("Head", GFX::GOSTEK_MORDA, 9, 12, 0, 0.5, 1, 1, 1, 0, color_skin, alpha_base),

	GostekSprite("Head_Dmg", GFX::GOSTEK_RANNY_MORDA, 9, 12, 0, 0.5, 0, 1, 1, 0, color_headblood, alpha_blood),

	GostekSprite("Head_Dead", GFX::GOSTEK_MORDA, 9, 12, 0.5, 0.5, 0, 1, 1, 0, color_skin, alpha_base),

	GostekSprite("Head_Dead_Dmg", GFX::GOSTEK_RANNY_MORDA, 9, 12, 0.5, 0.5, 0, 1, 1, 0, color_headblood, alpha_blood),
	...
	GostekSprite("Hair_Dreadlocks", GFX::GOSTEK_HAIR1, 9, 12, 0, 0.5, 0, 1, 1, 0, color_hair, alpha_base),

	GostekSprite("Hair_Dreadlock1", GFX::GOSTEK_DRED, 23, 24, 0, 1.22, 0, 0, 1, 0, color_hair, alpha_base),

	GostekSprite("Hair_Dreadlock2", GFX::GOSTEK_DRED, 23, 24, 0.1, 0.5, 0, 0, 1, 0, color_hair, alpha_base),

	GostekSprite("Hair_Dreadlock3", GFX::GOSTEK_DRED, 23, 24, 0.04, -0.3, 0, 0, 1, 0, color_hair, alpha_base),

	GostekSprite("Hair_Dreadlock4", GFX::GOSTEK_DRED, 23, 24, 0, -0.9, 0, 0, 1, 0, color_hair, alpha_base),

	GostekSprite("Hair_Dreadlock5", GFX::GOSTEK_DRED, 23, 24, -0.2, -1.35, 0, 0, 1, 0, color_hair, alpha_base),
	...
	GostekSprite("Cigar", GFX::GOSTEK_CYGARO, 9, 12, -0.125, 0.4, 0, 1, 1, 0, color_cygar, alpha_base),

	GostekSprite("Silver_Lchain", GFX::GOSTEK_LANCUCH, 10, 22, 0.1, 0.5, 0, 0, 1, 0, color_none, alpha_base),

	GostekSprite("Silver_Rchain", GFX::GOSTEK_LANCUCH, 11, 22, 0.1, 0.5, 0, 0, 1, 0, color_none, alpha_base),

	GostekSprite("Silver_Pendant", GFX::GOSTEK_METAL, 22, 21, 0.5, 0.7, 0, 1, 1, 0, color_none, alpha_base),

	GostekSprite("Golden_Lchain", GFX::GOSTEK_ZLOTYLANCUCH, 10, 22, 0.1, 0.5, 0, 0, 1, 0, color_none, alpha_base),

	GostekSprite("Golden_Rchain", GFX::GOSTEK_ZLOTYLANCUCH, 11, 22, 0.1, 0.5, 0, 0, 1, 0, color_none, alpha_base),

	GostekSprite("Golden_Pendant", GFX::GOSTEK_ZLOTO, 22, 21, 0.5, 0.5, 0, 1, 1, 0, color_none, alpha_base),

	GostekSprite("Frag_Grenade1", GFX::WEAPONS_FRAG_GRENADE, 5, 6, 0.5, 0.1, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Frag_Grenade2", GFX::WEAPONS_FRAG_GRENADE, 5, 6, 0.5, 0.1, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Frag_Grenade3", GFX::WEAPONS_FRAG_GRENADE, 5, 6, 0.5, 0.1, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Frag_Grenade4", GFX::WEAPONS_FRAG_GRENADE, 5, 6, 0.5, 0.1, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Frag_Grenade5", GFX::WEAPONS_FRAG_GRENADE, 5, 6, 0.5, 0.1, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Cluster_Grenade1", GFX::WEAPONS_CLUSTER_GRENADE, 5, 6, 0.5, 0.3, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Cluster_Grenade2", GFX::WEAPONS_CLUSTER_GRENADE, 5, 6, 0.5, 0.3, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Cluster_Grenade3", GFX::WEAPONS_CLUSTER_GRENADE, 5, 6, 0.5, 0.3, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Cluster_Grenade4", GFX::WEAPONS_CLUSTER_GRENADE, 5, 6, 0.5, 0.3, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Cluster_Grenade5", GFX::WEAPONS_CLUSTER_GRENADE, 5, 6, 0.5, 0.3, 0, 0, 0, 0, color_none, alpha_nades),

	GostekSprite("Primary_Deagles", GFX::WEAPONS_DEAGLES, 16, 15, 0.1, 0.8, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Deagles_Clip", GFX::WEAPONS_DEAGLES_CLIP, 16, 15, 0.1, 0.8, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Deagles_Fire", GFX::WEAPONS_DEAGLES_FIRE, 16, 15, -0.5, 1, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Mp5", GFX::WEAPONS_MP5, 16, 15, 0.15, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Mp5_Clip", GFX::WEAPONS_MP5_CLIP, 16, 15, 0.15, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Mp5_Fire", GFX::WEAPONS_MP5_FIRE, 16, 15, -0.65, 0.85, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Ak74", GFX::WEAPONS_AK74, 16, 15, 0.15, 0.5, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Ak74_Clip", GFX::WEAPONS_AK74_CLIP, 16, 15, 0.15, 0.5, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Ak74_Fire", GFX::WEAPONS_AK74_FIRE, 16, 15, -0.37, 0.8, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Steyr", GFX::WEAPONS_STEYR, 16, 15, 0.2, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Steyr_Clip", GFX::WEAPONS_STEYR_CLIP, 16, 15, 0.2, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Steyr_Fire", GFX::WEAPONS_STEYR_FIRE, 16, 15, -0.24, 0.75, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Spas", GFX::WEAPONS_SPAS, 16, 15, 0.1, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Spas_Clip", 0, 16, 15, 0, 0, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Spas_Fire", GFX::WEAPONS_SPAS_FIRE, 16, 15, -0.2, 0.9, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Ruger", GFX::WEAPONS_RUGER, 16, 15, 0.1, 0.7, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Ruger_Clip", 0, 16, 15, 0, 0, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Ruger_Fire", GFX::WEAPONS_RUGER_FIRE, 16, 15, -0.35, 0.85, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_M79", GFX::WEAPONS_M79, 16, 15, 0.1, 0.7, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_M79_Clip", GFX::WEAPONS_M79_CLIP, 16, 15, 0.1, 0.7, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_M79_Fire", GFX::WEAPONS_M79_FIRE, 16, 15, -0.4, 0.8, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Barrett", GFX::WEAPONS_BARRETT, 16, 15, 0.15, 0.7, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Barrett_Clip", GFX::WEAPONS_BARRETT_CLIP, 16, 15, 0.15, 0.7, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Barrett_Fire", GFX::WEAPONS_BARRETT_FIRE, 16, 15, -0.15, 0.8, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Minimi", GFX::WEAPONS_MINIMI, 16, 15, 0.15, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Minimi_Clip", GFX::WEAPONS_MINIMI_CLIP, 16, 15, 0.15, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Minimi_Fire", GFX::WEAPONS_MINIMI_FIRE, 16, 15, -0.2, 0.9, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Minigun_Clip", GFX::WEAPONS_MINIGUN_CLIP, 8, 7, 0.5, 0.1, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Minigun", GFX::WEAPONS_MINIGUN, 16, 15, 0.05, 0.5, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Minigun_Fire", GFX::WEAPONS_MINIGUN_FIRE, 16, 15, -0.2, 0.45, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Socom", GFX::WEAPONS_SOCOM, 16, 15, 0.2, 0.55, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Socom_Clip", GFX::WEAPONS_SOCOM_CLIP, 16, 15, 0.2, 0.55, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Socom_Fire", GFX::WEAPONS_SOCOM_FIRE, 16, 15, -0.24, 0.85, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Knife", GFX::WEAPONS_KNIFE, 16, 20, -0.1, 0.6, 0, 1, 0, 0, color_none, alpha_base),
	...
	GostekSprite("Primary_Chainsaw", GFX::WEAPONS_CHAINSAW, 16, 15, 0.1, 0.5, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Chainsaw_Clip", 0, 16, 15, 0, 0, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Chainsaw_Fire", GFX::WEAPONS_CHAINSAW_FIRE, 16, 15, 0, 0, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Law", GFX::WEAPONS_LAW, 16, 15, 0.1, 0.6, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Law_Clip", 0, 16, 15, 0, 0, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Law_Fire", GFX::WEAPONS_LAW_FIRE, 16, 15, -0.1, 0.55, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Bow", GFX::WEAPONS_BOW, 16, 15, -0.4, 0.55, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Bow_Arrow", GFX::WEAPONS_BOW_A, 16, 15, 0, 0.55, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Bow_String", GFX::WEAPONS_BOW_S, 16, 15, -0.4, 0.55, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Bow_Reload", GFX::WEAPONS_BOW, 16, 15, -0.4, 0.55, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Bow_Arrow_Reload", GFX::WEAPONS_ARROW, 16, 20, 0, 0.55, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite(
		"Primary_Bow_String_Reload", GFX::WEAPONS_BOW_S, 16, 15, -0.4, 0.55, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Bow_Fire", GFX::WEAPONS_BOW_FIRE, 16, 15, 0, 0, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Flamer", GFX::WEAPONS_FLAMER, 16, 15, 0.2, 0.7, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Flamer_Clip", 0, 16, 15, 0, 0, 0, 1, 0, 0, color_none, alpha_base),

	GostekSprite("Primary_Flamer_Fire", GFX::WEAPONS_FLAMER_FIRE, 16, 15, 0, 0, 0, 0, 0, 0, color_none, alpha_base),

	GostekSprite("Right_Arm", GFX::GOSTEK_RAMIE, 10, 13, 0, 0.6, 1, 1, 1, 0, color_main, alpha_base),

	GostekSprite("Right_Arm_Dmg", GFX::GOSTEK_RANNY_RAMIE, 10, 13, -0.1, 0.5, 0, 1, 1, 0, color_none, alpha_blood),

	GostekSprite("Right_Forearm", GFX::GOSTEK_REKA, 13, 16, 0, 0.6, 1, 0, 1, 5, color_main, alpha_base),

	GostekSprite("Right_Forearm_Dmg", GFX::GOSTEK_RANNY_REKA, 13, 16, 0, 0.6, 0, 1, 1, 5, color_none, alpha_blood),
...
static void drawgosteksprite(
	pgfxsprite sprite, float x, float y, float sx, float sy, float cx, float cy, float r, const tgfxcolor& color)
{
...
void rendergostek(tsprite& soldier)
{
	...
	if ((soldier.style != tsprite::Style::Default) || (soldier.ceasefirecounter > GS::GetGame().GetCeasefiretime() - 5)
		|| ((CVar::sv_realisticmode) && (soldier.visible == 0)) or (soldier.isspectator())
		or (soldier.player->name.empty()) or (soldier.player->demoplayer))
	{
		return;
	}
	...
	if ((CVar::sv_realisticmode) && (soldier.visible > 0) && (soldier.visible < 45) && (soldier.alpha > 60))
	{
	...
	std::int32_t const n = soldier.tertiaryweapon.ammocount - ord(soldier.bodyanimation.id == AnimationType::Throw);
	...
	{
		bool const grabbed =
			(AnimationType::Wipe == soldier.bodyanimation.id || AnimationType::TakeOff == soldier.bodyanimation.id)
	...
	for (i = GOSTEK_FIRST; i < GOSTEK_LAST; i++)
	{
		...
		if (const auto& gs = gosteksprites[i]; (visible.contains(i)) && (gs.image != 0))
		{
			...
			cx = cx * gGlobalStateGameRendering.textures[tex]->width * gGlobalStateGameRendering.textures[tex]->scale;
			cy = cy * gGlobalStateGameRendering.textures[tex]->height * gGlobalStateGameRendering.textures[tex]->scale;
			...
			drawgosteksprite(gGlobalStateGameRendering.textures[tex], x1, y1 + 1, sx, sy, cx, cy, r, color[gs.color]);
		}
	}
}
