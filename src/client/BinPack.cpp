...
static auto ScoreRect(TBinPack& bp, std::int32_t w, std::int32_t h, std::int32_t& besty, std::int32_t& bestx)
	-> tbprect;
...
auto ScoreRect(TBinPack& bp, std::int32_t w, std::int32_t h, std::int32_t& besty, std::int32_t& bestx) -> tbprect
{
	tbprect bestrect;
...
auto TRectList::operator[](int32_t index) -> tbprect&
{
