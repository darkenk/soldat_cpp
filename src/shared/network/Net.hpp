...
class TNetwork
{
  ...
  public:
    ...
    bool SetGlobalConfigValueInt32(ESteamNetworkingConfigValue eValue, std::int32_t val);
    ...
    void SetDebugLevel(ESteamNetworkingSocketsDebugOutputType Level);
...
{
    tmsgheader header;
    std::array<char, soldat_version_chars> version;
