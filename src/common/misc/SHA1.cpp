...
namespace
{
	...
	inline void R0(const uint32_t block[BLOCK_INTS],
		const uint32_t v,
		uint32_t& w,
		const uint32_t x,
		const uint32_t y,
	...
	inline void R1(uint32_t block[BLOCK_INTS],
		const uint32_t v,
		uint32_t& w,
		const uint32_t x,
		const uint32_t y,
	...
	inline void R2(uint32_t block[BLOCK_INTS],
		const uint32_t v,
		uint32_t& w,
		const uint32_t x,
		const uint32_t y,
	...
	inline void R3(uint32_t block[BLOCK_INTS],
		const uint32_t v,
		uint32_t& w,
		const uint32_t x,
		const uint32_t y,
	...
	inline void R4(uint32_t block[BLOCK_INTS],
		const uint32_t v,
		uint32_t& w,
		const uint32_t x,
		const uint32_t y,
...
std::array<std::uint32_t, 5> SHA1::final()
{
...
std::array<std::uint32_t, 5> SHA1::from_file(const std::string& filename)
{
