...
tintersectionresult islineintersectingcircle(tvector2 line1, tvector2 line2, tvector2 circlecenter, float radius);
bool linecirclecollision(const tvector2& startpoint,
	const tvector2& endpoint,
	const tvector2& circlecenter,
	float radius,
	tvector2& collisionpoint);
