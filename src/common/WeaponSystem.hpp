...
public:
	...
	std::uint64_t GetLoadedWMChecksum() const { return LoadedWMChecksum; }
	void SetLoadedWMChecksum(std::uint64_t _LoadedWMChecksum) { LoadedWMChecksum = _LoadedWMChecksum; }

	std::uint64_t GetDefaultWMChecksum() const { return DefaultWMChecksum; }
	void SetDefaultWMChecksum(std::uint64_t _DefaultWMChecksum) { DefaultWMChecksum = _DefaultWMChecksum; }

	GunsDescription& GetGuns() { return Guns; }

	GunsDescription& GetDefaultGuns() { return DefaultGuns; }
