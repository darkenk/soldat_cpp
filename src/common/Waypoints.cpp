...
auto twaypoints::findclosest(float x, float y, std::int32_t radius, std::int32_t currwaypoint) const -> std::int32_t
...
auto twaypoints::createwaypoint(std::int32_t sx, std::int32_t sy, std::int32_t spath) -> std::int32_t
{
	std::int32_t i = 0;
